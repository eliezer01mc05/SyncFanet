...
#ifndef __INET__INETMANET_OLSRPKT_M_H
#define __INET__INETMANET_OLSRPKT_M_H
...
/**
 * Class generated from <tt>uavnet/routing/manet/olsr/OLSRpkt.msg:406</tt> by nedtool.
 * <pre>
 * //
 ...
 * </pre>
 */
class OLSR_pkt : public ::omnetpp::cPacket
{
  protected:
  ...
  public:
    OLSR_pkt(const char *name=nullptr, short kind=0);
    OLSR_pkt(const OLSR_pkt& other);
    virtual ~OLSR_pkt();
    OLSR_pkt& operator=(const OLSR_pkt& other);
    virtual OLSR_pkt *dup() const override {return new OLSR_pkt(*this);}
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const OLSR_pkt& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, OLSR_pkt& obj) {obj.parsimUnpack(b);}

} // namespace inetmanet
} // namespace inet

#endif // ifndef __INET__INETMANET_OLSRPKT_M_H
